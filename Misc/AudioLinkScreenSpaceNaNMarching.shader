Shader "3/ScreenShaderNaN"
{
	SubShader
	{
		Tags
		{
			"Queue"="Overlay" "IgnoreProjector"="True" "RenderType"="Overlay" "PreviewType"="Plane" "VRCFallback"="Hidden"
		}
		GrabPass
		{
			"_MyGrabTex"
		...
		Pass
		{
			...
			#include "Assets/3/Shaders/CGIncludes/Commons.cginc"
