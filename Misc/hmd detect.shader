Shader "3/hmd-detect"
{
	...
	SubShader
	{
		Pass
		{
			...
			#include "Assets/shader/3Misc/FortyPixelPrint.cginc"


			// FOV values map to unity_CameraProjection._m11
			...
			#define OCULUS_QUEST_2_CP11 0.869
			
			#define PICO_NEO_3 1832/1920

			
			#define HP_REVERB_G2 2160/2160
			#define HP_REVERB_G2_CP11 0.947 //0.948
